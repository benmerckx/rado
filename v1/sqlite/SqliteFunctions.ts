import {input, type Input} from '../core/Expr.ts'
...
type SqliteFunctions = {
  ...
  json_array<T>(...values: HasSql<T>): HasSql<Array<T>>
  jsonb_array<T>(...values: HasSql<T>): HasSql<Array<T>>
  json_array_length(json: HasSql<Array<unknown>>): HasSql<number>
  ...
  iif<T>(x: Input<boolean>, y: Input<T>, z: Input<T>): HasSql<T>
   ...
   */
  exists(cursor: HasQuery): HasSql<boolean>

  /** Use the match operator for the FTS5 module */
  match(table: HasTable, searchTerm: Input<string>): HasSql<boolean>

  /** Returns a real value reflecting the accuracy of the current match */
  bm25(table: HasTable, ...weights: Array<Input<number>>): HasSql<number>
  ...
  abs(x: Input<number>): HasSql<number>
  ...
  char(...arg: Array<Input<number>>): HasSql<string>
  ...
  coalesce(x: Input, y: Input, ...rest: Array<Input>): HasSql
  ...
  // hex(x:Input<Bytes>): HasSql<string> {
  //  return new HasSql(Call('hex', [expr(x)]));
  // }

  /** The ifnull() function returns a copy of its first non-NULL argument, or NULL if both arguments are NULL. Ifnull() must have exactly 2 arguments. The ifnull() function is equivalent to coalesce() with two arguments.*/
  ifnull<T>(x: Input<T>, y: Input<T>): HasSql<T>
  ...
  instr(x: Input<string>, y: Input<string>): HasSql<number>
  ...
  likelihood(x: Input<boolean>, y: number): HasSql<boolean>
  ...
  likely(x: Input<boolean>): HasSql<boolean>
  ...
  lower(x: Input<string>): HasSql<string>
  ...
  ltrim(x: Input<string>, y?: Input<string>): HasSql<string>
  ...
  max<T>(x: Input<T>, ...rest: Array<Input<T>>): HasSql<T>
  ...
  prnumberf(format: string, ...rest: Array<HasSql>): HasSql<string>
  ...
  // randomblob(x:Input<X>): HasSql<X> {
  //  return new HasSql(Call('randomblob', [expr(x)]));
  // }
  ...
  replace(x: Input<string>, y: Input<string>, z: Input<string>): HasSql<string>
  ...
  round(x: Input<number>, y?: Input<number>): HasSql<number>
  ...
  rtrim(x: Input<string>, y?: Input<string>): HasSql<string>
  ...
  sign(x: Input<number>): HasSql<number>
  ...
  soundex(x: Input<string>): HasSql<string>
  ...
  unicode(x: Input<string>): HasSql<number>
  ...
  unlikely(x: Input<boolean>): HasSql<boolean>
  ...
  upper(x: Input<string>): HasSql<string>
  ...
  avg(x: HasSql<number>): HasSql<number>

  /** The group_concat() function returns a string which is the concatenation of all non-NULL values of X. If parameter Y is present then it is used as the separator between instances of X. A comma (",") is used as the separator if Y is omitted. The order of the concatenated elements is arbitrary. */
  group_concat(x: Input<string>, y?: Input<string>): HasSql<string>
   ...
   */
  sum(x: Input<number>): HasSql<number>
  ...
  acos(x: Input<number>): HasSql<number>

  /** Return the hyperbolic arccosine of X. */
  acosh(x: Input<number>): HasSql<number>

  /** Return the arcsine of X. The result is in radians. */
  asin(x: Input<number>): HasSql<number>

  /** Return the hyperbolic arcsine of X. */
  asinh(x: Input<number>): HasSql<number>

  /** Return the arctangent of X. The result is in radians. */
  atan(x: Input<number>): HasSql<number>
  ...
  atan2(x: Input<number>, y: Input<number>): HasSql<number>

  /** Return the hyperbolic arctangent of X. */
  atanh(x: Input<number>): HasSql<number>
  ...
  ceil(x: Input<number>): HasSql<number>

  /** Return the cosine of X. X is in radians. */
  cos(x: Input<number>): HasSql<number>

  /** Return the hyperbolic cosine of X. */
  cosh(x: Input<number>): HasSql<number>

  /** Convert value X from radians numbero degrees. */
  degrees(x: Input<number>): HasSql<number>

  /** Compute e (Euler's number, approximately 2.71828182845905) raised to the power X. */
  exp(x: Input<number>): HasSql<number>
  ...
  floor(x: Input<number>): HasSql<number>

  /** Return the natural logarithm of X. */
  ln(x: Input<number>): HasSql<number>
  ...
  log(x: Input<number>, y?: Input<number>): HasSql<number>

  /** Return the logarithm base-2 for the number X. */
  log2(x: Input<number>): HasSql<number>
  ...
  mod(x: Input<number>, y: Input<number>): HasSql<number>

  /** Return an approximation for π. */
  pi(): HasSql<number>

  /** Compute X raised to the power Y. */
  pow(x: Input<number>, y: Input<number>): HasSql<number>

  /** Convert X from degrees numbero radians. */
  radians(x: Input<number>): HasSql<number>

  /** Return the sine of X. X is in radians. */
  sin(x: Input<number>): HasSql<number>

  /** Return the hyperbolic sine of X. */
  sinh(x: Input<number>): HasSql<number>

  /** Return the square root of X. NULL is returned if X is negative. */
  sqrt(x: Input<number>): HasSql<number>

  /** Return the tangent of X. X is in radians. */
  tan(x: Input<number>): HasSql<number>

  /** Return the hyperbolic tangent of X. */
  tanh(x: Input<number>): HasSql<number>
  ...
  trunc(x: Input<number>): HasSql<number>

  // =====================================================
  // https://www.sqlite.org/lang_datefunc.html
  // =====================================================
  date(timeValue: Input, ...rest: Array<Input<string>>): HasSql<string>

  time(timeValue: Input, ...rest: Array<Input<string>>): HasSql<string>

  datetime(timeValue: Input, ...rest: Array<Input<string>>): HasSql<string>

  julianday(timeValue: Input, ...rest: Array<Input<string>>): HasSql<string>
...
export function cast(x: Input, type: 'text'): HasSql<string>
export function cast(x: Input, type: 'real'): HasSql<number>
export function cast(x: Input, type: 'integer'): HasSql<number>
export function cast(x: Input, type: 'numeric'): HasSql<number>
